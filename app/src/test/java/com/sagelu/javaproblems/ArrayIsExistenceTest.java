...
/**
 ...
 也就是说如果要查找的数字不在数组的右上角，则每－次都在数组的查找范围中剔除行或者一列，
 这样每一步都可以缩小查找的范围，直到找到要查找的数字，或者查找范围为空。
 */
public class ArrayIsExistenceTest {
    @Test
    public void addition_isCorrect() throws Exception {
        //定义二维数组
        int[ ] [ ] arr={{1,2,3},{4,5,6}};
        int element=5;
        boolean isExistence = find(arr, element);
        System.out.println(element+"元素是否存在："+isExistence);
    }
